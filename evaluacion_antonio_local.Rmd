...
**Conclusiones pedagógicas:** 1. **Granularidad de las clases:** Clasificar 5 estrellas resulta mucho más complejo (64.54% de accuracy) debido al solapamiento léxico entre valoraciones contiguas (4 vs 5 estrellas y 1 vs 2 estrellas). Al condensar la escala en 3 sentimientos (`negativo`, `neutro`, `positivo`), el rendimiento asciende notablemente al 86.35%. 2. **Impacto de la clase neutra:** La eliminación de la clase neutra (3 estrellas) suprime la principal fuente de incertidumbre léxica, alcanzando tasas de acierto superiores al **97%** en todos los clasificadores binarios. 3. **Comparativa algorítmica binaria:** En la tarea binaria, los tres algoritmos presentan un comportamiento sobresaliente y muy parejo: **fastText** (97.48%) y la **Regresión Logística** (97.39%) obtienen prácticamente el mismo nivel de precisión, mientras que **Naive Bayes** (97.08%) se sitúa ligeramente por detrás pero con una velocidad de ajuste y simplicidad computacional excepcional.
